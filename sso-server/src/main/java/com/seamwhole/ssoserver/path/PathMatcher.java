package com.seamwhole.ssoserver.path;
 ...
 *
 * <p>The default implementation is {@link com.seamwhole.ssoserver.path.impl.AntPathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
