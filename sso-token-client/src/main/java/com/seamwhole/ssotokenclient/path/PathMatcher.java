package com.seamwhole.ssotokenclient.path;
 ...
 *
 * <p>The default implementation is {@link com.seamwhole.ssotokenclient.path.impl.AntPathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
