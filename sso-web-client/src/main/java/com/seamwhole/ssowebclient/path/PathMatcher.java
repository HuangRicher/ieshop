package com.seamwhole.ssowebclient.path;
 ...
 *
 * <p>The default implementation is {@link com.seamwhole.ssowebclient.path.impl.AntPathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
